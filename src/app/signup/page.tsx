    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f7f8f9] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-xl font-bold text-[#161616]">Daftar Akun Baru</h1>
          <p className="mt-1 text-sm text-[#667085]">Mulai gunakan Indigo Connect</p>
        </div>
        ...
        <form action={action} className="card-legion space-y-5 p-6">
          ...
          <p className="text-center text-sm text-[#667085]">
            Sudah punya akun?{" "}
            <Link href="/login" className="font-medium text-[#875bf7] hover:underline">
              Masuk
            </Link>
          </p>
        </form>
